      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <button
            ...
            className="border border-foreground/20 text-foreground px-8 py-3 rounded-full hover:border-foreground/40 hover:bg-foreground/5 transition-all font-medium text-lg"
          >
            Get In Touch
          </button>
        </div>
